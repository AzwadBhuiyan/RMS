...
<body class="antialiased" style="background-color: rgb(246, 246, 255)">
    ...
    <table class="table table-striped container bg-white">
        <thead>
            <tr>
        ...
        <tbody>
            @foreach ($enrolled as $item)
                <tr>
                    <td>{{ $item }}</td>
                    <td>{{ $sets[$loop->index] }}</td>
                    <td>{{ $slass[$loop->index] }}</td>
                    <td>{{ $sbe[$loop->index] }}</td>
                    <td>{{ $sels[$loop->index] }}</td>
                </tr>
            @endforeach
            {{-- <tr>
                <th scope="row">1</th>
